...
<>      <div className="d-flex align-items-center justify-content-between">
        ...
        <button type="button" className="btn btn-outline-primary">Start a post</button>
      </div>
      ...
      <button type="button" className="btn no-border btn-lg btn-block">see all activity</button>
</>
